<%@ Page Title="" Language="C#" MasterPageFile="~/Repairshop/Repairshop.master" AutoEventWireup="true" CodeBehind="ViewInspection.aspx.cs" Inherits="UC3.Repairshop.ViewInspection" %>
<asp:Content ID="Content1" ContentPlaceHolderID="RepairShopContent" runat="server">
    ...
    <div class="row">
        <div class="col-lg-8">
            <h5><b>Inspection Report (by ID):</b></h5>
            <asp:DropDownList ID="InspectionIDDropdown" runat="server" CssClass="dropdown" Width="100%">
            </asp:DropDownList>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <asp:Button ID="EditBtn" runat="server" Text="Edit Inspection" />
        </div>
    </div>
